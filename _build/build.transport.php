...
$sources = array(
    ...
    'pdotools_core' => $root . 'core/components/pdotools/model/pdotools/pdofetchlocalizator3.class.php',
);
unset($root);
...
if (defined('PKG_AUTO_INSTALL') && PKG_AUTO_INSTALL) {
    ...
    if ($package->install()) {
        ...
        $modx->log(\MODX\Revolution\modX::LOG_LEVEL_INFO, '[Localizator3] Cache cleared');
        $modx->log(\MODX\Revolution\modX::LOG_LEVEL_INFO, '✅ Успешно установлен пакет ' . $signature);
    }
}
